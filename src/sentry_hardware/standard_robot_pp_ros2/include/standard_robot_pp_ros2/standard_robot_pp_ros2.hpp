...
#include "sentry_interfaces/msg/buff.hpp"
#include "sentry_interfaces/msg/event_data.hpp"
#include "sentry_interfaces/msg/game_robot_hp.hpp"
#include "sentry_interfaces/msg/game_status.hpp"
#include "sentry_interfaces/msg/ground_robot_position.hpp"
#include "sentry_interfaces/msg/rfid_status.hpp"
#include "sentry_interfaces/msg/robot_state_info.hpp"
...
private:
  ...
  rclcpp::Publisher<sentry_interfaces::msg::RobotStateInfo>::SharedPtr robot_state_info_pub_;
  rclcpp::Publisher<sentry_interfaces::msg::EventData>::SharedPtr event_data_pub_;
  rclcpp::Publisher<sentry_interfaces::msg::GameRobotHP>::SharedPtr all_robot_hp_pub_;
  rclcpp::Publisher<sentry_interfaces::msg::GameStatus>::SharedPtr game_status_pub_;
  rclcpp::Publisher<geometry_msgs::msg::Twist>::SharedPtr robot_motion_pub_;
  rclcpp::Publisher<sentry_interfaces::msg::GroundRobotPosition>::SharedPtr
    ground_robot_position_pub_;
  rclcpp::Publisher<sentry_interfaces::msg::RfidStatus>::SharedPtr rfid_status_pub_;
  rclcpp::Publisher<sentry_interfaces::msg::RobotStatus>::SharedPtr robot_status_pub_;
  rclcpp::Publisher<sensor_msgs::msg::JointState>::SharedPtr joint_state_pub_;
  rclcpp::Publisher<sentry_interfaces::msg::Buff>::SharedPtr buff_pub_;
  ...
  rclcpp::Subscription<sentry_interfaces::msg::Target>::SharedPtr cmd_tracking_sub_;
  ...
  void visionTargetCallback(const sentry_interfaces::msg::Target::SharedPtr msg);
