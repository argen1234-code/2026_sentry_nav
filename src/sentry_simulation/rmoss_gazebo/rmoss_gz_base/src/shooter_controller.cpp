...
: node_(node), shoot_actuator_(shoot_actuator)
{
  ...
  rmoss_shoot_cmd_sub_ = node_->create_subscription<sentry_interfaces::msg::ShootCmd>(
...
void ShooterController::rmoss_shoot_cb(const sentry_interfaces::msg::ShootCmd::SharedPtr msg)
{
...
{
  sentry_interfaces::msg::ShootCmd cmd;
